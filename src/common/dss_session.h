...
typedef enum en_dss_thread_status {
    DSS_THREAD_STATUS_IDLE = 0,
    DSS_THREAD_STATUS_RUNNING,
    DSS_THREAD_STATUS_PAUSING,
    DSS_THREAD_STATUS_PAUSED,
} dss_thread_status_t;
